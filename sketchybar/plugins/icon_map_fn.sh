...
function icon_map() {
  ...
  "VMware Fusion")
    ...
    ;;
  "Alacritty" | "Hyper" | "iTerm2" | "kitty" | "Terminal" | "終端機" | "WezTerm")
  ...
  "Music" | "音樂")
    icon_result=":music:"
    ;;
  "Calendar" | "日曆" | "Fantastical" | "Cron" | "Amie")
  ...
  "Microsoft Word")
    ...
    ;;
  "Safari" | "Safari瀏覽器" | "Safari Technology Preview")
    icon_result=":safari:"
    ;;
  "MoneyMoney")
    icon_result=":bank:"
  ...
  "Bear")
    icon_result=":bear:"
    ;;
  "System Preferences" | "System Settings" | "系統設置")
    icon_result=":gear:"
    ;;
  "Nova")
    icon_result=":nova:"
